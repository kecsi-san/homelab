...
ID, `gpgsign` hardcoded `false` because the key material was never distributed) —
abandoned 2026-07-19 after the actual GPG key was lost when its old work computer
was decommissioned.
