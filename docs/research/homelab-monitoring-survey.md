...
|------|-------|---------|------|---------------|-------|
| [khuedoan/homelab](https://github.com/khuedoan/homelab) | 9.3k | Prometheus + Grafana | Loki | n/a | Most-starred pure-k8s homelab; Cilium/Hubble for network observability |
...
| [lisenet/kubernetes-homelab](https://github.com/lisenet/kubernetes-homelab) | 502 | Prometheus + Grafana + Alertmanager | Loki + Promtail | n/a | etcd, HAProxy, Bind DNS, MikroTik exporters; Kiali for Istio; Slack alerting |
...
| [gruberdev/homelab](https://github.com/gruberdev/homelab) | 248 | kube-prometheus (kube-prometheus, not KPS) | n/a | Uptime Kuma | One of the few repos using Uptime Kuma over Gatus |
...
| TechnoTim (YouTube/docs) | 1.2k (docs repo) | kube-prometheus-stack | n/a | n/a | Recommends KPS in tutorials; most-referenced homelab k8s video content |
| [rcourtman/Pulse](https://github.com/rcourtman/Pulse) | 5.8k | Built-in (Proxmox/Docker) | n/a | Built-in | Not a k8s GitOps repo; trending standalone dashboard for Proxmox+Docker homelabs |
