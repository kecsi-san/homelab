...
| Idle RAM | 4 GB minimum (6+ containers) | 256 MB to 1 GB | 50-100 MB |
...
|---|---|---|---|
| Self-hosted | Yes | No (SaaS) | n/a |
| RAM | 2-4 GB (+ PostgreSQL) | Zero | n/a |
| Setup | Very high (build a TypeScript app) | Low | n/a |
| Value at solo scale | Low-medium | Medium | n/a |
...
| Adds value when | n/a | DB creds + PKI + multi-runtime secrets | When Vault or cloud KMS exists |
