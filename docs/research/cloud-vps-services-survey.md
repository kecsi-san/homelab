...
| Full self-hosted email is rare but sovereign proves it works | Bare-metal Ansible role is the right approach; see [cloud-email-server-components.md](cloud-email-server-components.md) for component decisions |
